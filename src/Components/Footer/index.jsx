                        ...
                        <div class="col-md-6 col-lg">
                            <div class="ftco-footer-widget mb-4">
                                ...
                                <div class="block-21 mb-4 d-flex">
                                    <a class="blog-img img rounded" href="#this" style={{ backgroundImage:`url(${image1})`}}></a>
                                    <div class="text">
                                        <div class="meta">
                                ...
                                <div class="block-21 mb-4 d-flex">
                                    <a class="blog-img img rounded" style={{ backgroundImage:`url(${image2})`}}></a>
                                    <div class="text">
                                        <div class="meta">
                                            <div><a href="#"><span class="fa fa-calendar"></span> Jan. 18, 2021</a></div>
                                            <div><a href="#"><span class="fa fa-user"></span> Admin</a></div>
                                ...
                                <div class="block-21 mb-4 d-flex">
                                    <a class="blog-img img rounded" style={{ backgroundImage:`url(${image4})`}}></a>
                                    <div class="text">
                                        <div class="meta">
                                            <div><a href="#"><span class="fa fa-calendar"></span> Jan. 18, 2021</a></div>
                                            <div><a href="#"><span class="fa fa-user"></span> Admin</a></div>
                    ...
                    <div class="container-xl">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <p class="mb-0" style={{fontSize:'14'}}>Copyright &copy;
